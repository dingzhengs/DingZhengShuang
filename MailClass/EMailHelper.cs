...
namespace MailClass
{
    public class EmailHelper
    {
        ...
        public EmailHelper(string smtp, int port, string email, string psd)
        {
            this._STEPNAME = smtp;
            this._STEPPORT = port;
        ...
        public EmailHelper(string smtp, int port, string email, string emailBlonger, string psd)
        {
            this._STEPNAME = smtp;
            this._STEPPORT = port;
            this._USEREMAIL = email;
        ...
        /// <returns></returns>
        public string SendEmail(string[] tos, string subject, string text, string html, string path)
        {
            try
            {
                ...
                using (var client = new SmtpClient())
                {
                    ...
                    client.Connect(this._STEPNAME, this._STEPPORT);
