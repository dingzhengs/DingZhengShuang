...
namespace MailClass.WebServices
{
    /// <summary>
    ...
    public class WebSvcHelper
    {
        ...
        {
            HttpWebRequest request = (HttpWebRequest)WebRequest.Create(URL+ "?" + ParsToString(Pars));
            request.Method = "GET";
            request.ContentType = "application/x-www-form-urlencoded";
            SetWebRequest(request);
            return ReadResponse(request.GetResponse());
        ...
        private static XmlDocument QuerySoapWebService(String URL, String MethodName, Hashtable Pars, string XmlNs)
        {
            ...
            doc.LoadXml(ReadResponse(request.GetResponse()));
