...
namespace MailClass
{
    public class DatabaseManager
    {
        ...
        public DatabaseManager(string databaseName)
        {
            ...
            var connectInstance = System.Configuration.ConfigurationManager.ConnectionStrings[databaseName];

            string connectString = connectInstance.ConnectionString;

            string providerName = connectInstance.ProviderName;
        ...
        public int ExecuteNonQuery(string sql, object parameters = null)
        {
            ...
            {
                if (e.TargetSite.Name != "ExtractAccessorValuesIntoParam")// 插入数据库成功 但是提示NullReferenceException错误
                {
